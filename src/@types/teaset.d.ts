declare module 'teaset' {
  ...
  export class OverlayPopoverView extends Component<
    IOverlayPopoverViewProps,
    any
  > {}
  ...
  type ActionPopoverProps = BaseOverlay & {
    show: (fromBounds?: boolean, items?: Array<any>, options?: any) => number;
  };
  ...
  type ActionSheetProps = BaseOverlay & {
    show: (
      items?: Array<IActionSheetItemProps>,
      cancelItem?: any,
      options?: any,
    ) => number;
  };
  ...
  export class Toast extends Overlay {
    ...
    static show: (options: any) => number;
    static message: (text: string, options?: any, position?: string) => number;
    static success: (text: string, options?: any, position?: string) => number;
    static fail: (text: string, options?: any, position?: string) => number;
    static smile: (text: string, options?: any, position?: string) => number;
    static sad: (text: string, options?: any, position?: string) => number;
    static info: (text: string, options?: any, position?: string) => number;
    static stop: (text: string, options?: any, position?: string) => number;
  }
  ...
  interface IPopoverPickerViewProps extends IOverlayPopoverViewProps {
    ...
    getItemText?: (item: any, index: number) => string;
    shadow?: boolean;
    onSelected: (item: any, index: number) => any;
  }
  ...
  export class PullPickerItem extends Component<
    IListRowProps & {selected?: boolean}
  > {}
  ...
  interface ISegmentedBarProps extends ViewProps {
    ...
    onChange?: (index: number) => any; //(index: number)
  }
  ...
  interface ISelectProps extends ViewProps {
    ...
    items?: Array<any>;
    getItemValue?: (item: any, index: number) => any; //(item: any, index: number) 选择项值，item=items[index]，为空时直接使用item
    getItemText?: (item: any, index: number) => any; //(item: any, index: number) return display text of item, item=items[index], use item when it's null
    ...
    onSelected?: (item: any, index: number) => any; //(item: any, index: number)
  }
  ...
  interface IStepperProps extends ViewProps {
    ...
    valueStyle?: StyleProp<TextStyle>;
    valueFormat?: (value: any) => any; //(value)
  ...
  interface ITransformViewProps extends ViewProps {
    ...
    magnetic?: boolean;
    tension?: boolean;
    onWillTransform?: (translateX: any, translateY: any, scale: any) => any; //(translateX: any, translateY: any, scale: any)
    onTransforming?: (translateX: any, translateY: any, scale: any) => any; //(translateX: any, translateY: any, scale: any)
    onDidTransform?: (translateX: any, translateY: any, scale: any) => any; //(translateX: any, translateY: any, scale: any)
    onWillInertialMove?: (
      translateX: any,
      translateY: any,
      newX: any,
      newY: any,
    ) => boolean; //(translateX: any, translateY: any, newX, newY), return ture or false
    onDidInertialMove?: (
      translateX: any,
      translateY: any,
      newX: any,
      newY: any,
    ) => any; //(translateX: any, translateY: any, newX, newY)
    onWillMagnetic?: (
      translateX: any,
      translateY: any,
      scale: any,
      ...
      newY: any,
      newscale: any,
    ) => boolean; //(translateX: any, translateY: any, scale, newX, newY, newscale: any), return ture or false
    onDidMagnetic?: (translateX: any, translateY: any, scale: any) => any; //(translateX: any, translateY: any, scale: any)
    onPress?: (event: GestureResponderEvent) => any; //(event)
    onLongPress?: (event: GestureResponderEvent) => any; //(event)
  }
  ...
  export class SwipeTouchableOpacity extends Component<
    ISwipeTouchableOpacityProps,
    any
  > {}
  ...
  interface AlbumViewProps extends ViewProps {
    ...
    onWillLoadImage?: (index: number) => void; //(index: number)
